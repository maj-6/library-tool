...
Library Tool Capture `0.5.2-alpha.13` (version code 44) is the Android
...
When Cloud or Auto sync encounters captures made without an account, it asks
before permanently associating those local captures with the signed-in account.
