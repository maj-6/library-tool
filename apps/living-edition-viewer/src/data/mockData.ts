...
export const designs: DesignDirection[] = [
  {
    ...
    marker: 'A',
    title: 'Scriptorium',
    subtitle: 'Aligned edition',
    description: 'Scan, transcription, and translation remain visible. Editing tools stay docked.',
    bestFor: 'Close reading and passage comparison',
    tradeoff: 'Reduced canvas area',
  },
  {
    id: 'spatial',
    marker: 'B',
    title: 'Spatial Lab',
    subtitle: 'Geometry editor',
    description: 'The page canvas leads. Docked tools manage boxes, polygons, hands, and marginalia.',
    bestFor: 'Segmentation and paleography',
    tradeoff: 'Text stays in a lower pane',
  },
  {
    id: 'queue',
    marker: 'C',
    ...
    description: 'A task list presents low-confidence passages and stale anchors as discrete decisions.',
    bestFor: 'Sustained editorial review',
    tradeoff: 'Page navigation is secondary',
  },
  {
    id: 'matrix',
    marker: 'D',
    title: 'Layer Matrix',
    subtitle: 'Layer comparison',
    description: 'A dense table shows engine output, editorial revisions, status, and lineage.',
    bestFor: 'Engine comparison and release QA',
    tradeoff: 'High information density',
  },
  {
    id: 'drafting',
    marker: 'E',
    title: 'Drafting Desk',
    subtitle: 'CAD workbench',
    description: 'A page canvas is surrounded by docked navigator, properties, text, and task panes.',
    bestFor: 'Region construction and page cleanup',
    tradeoff: 'Dense desktop chrome',
  },
  {
    id: 'register',
    marker: 'F',
    title: 'Parallel Register',
    subtitle: 'Synchronized evidence',
    description: 'Scan, source readings, translation, and problems remain aligned in fixed panes.',
    bestFor: 'Transcription and translation review',
    tradeoff: 'Smaller scan pane',
  },
  {
    id: 'console',
    marker: 'G',
    title: 'Catalog Console',
    subtitle: 'Master-detail workspace',
    description: 'A persistent object index drives catalog, edition, region, and entity detail panes.',
    bestFor: 'Library and authority maintenance',
    tradeoff: 'Geometry is one tool among several',
  },
]
...
export const manuscriptText: Record<string, string[]> = {
  mistral: [
